...
namespace Nethereum.UI
{
    public interface IEthereumHostProvider
    {
        ...
        Task<decimal> GetAccountBalance(string SelectedAccount);
        Task<decimal> GetTransactions(string SelectedAccount);
        Task<int> GetERC721Balance(string erc721TokenAddress, string SelectedAccount);
