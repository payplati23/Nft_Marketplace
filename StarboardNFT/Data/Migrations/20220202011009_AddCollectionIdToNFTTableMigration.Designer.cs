...
namespace StarboardNFT.Data.Migrations
{
    ...
    [Migration("20220202011009_AddCollectionIdToNFTTableMigration")]
    partial class AddCollectionIdToNFTTableMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StarboardNFT.Models.Activity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("StarboardNFT.Models.NFT", b =>
                {
                    ...
                    b.Property<int>("TotalNumberOfMintedNFT")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StarboardNFT.Models.NFTData", b =>
                {
                    ...
                    b.Property<int>("UniqueNumberOfMintedNFT")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StarboardNFT.Models.NFTFavorites", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("NFTFavorites");
                });

            modelBuilder.Entity("StarboardNFT.Models.NFTLikes", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StarboardNFT.Models.UserFollowing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("FollowingUserProfileHeaderId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("MainUserProfileHeaderId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FollowingUserProfileHeaderId");

                    b.HasIndex("MainUserProfileHeaderId");
            ...
            modelBuilder.Entity("StarboardNFT.Models.UserFollowing", b =>
                {
                    b.HasOne("StarboardNFT.Models.UserProfileHeader", "FollowingUserProfileHeader")
                        .WithMany()
                        .HasForeignKey("FollowingUserProfileHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StarboardNFT.Models.UserProfileHeader", "MainUserProfileHeader")
                        .WithMany()
                        .HasForeignKey("MainUserProfileHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FollowingUserProfileHeader");

                    b.Navigation("MainUserProfileHeader");
                });
