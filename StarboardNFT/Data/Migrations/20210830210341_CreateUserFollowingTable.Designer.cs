...
namespace StarboardNFT.Data.Migrations
{
    ...
    [Migration("20210830210341_CreateUserFollowingTable")]
    partial class CreateUserFollowingTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StarboardNFT.Models.UserFollowing", b =>
                {
                    ...
                    b.Property<Guid>("FollowedUserProfileId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FollowedUserProfileId");
            ...
            modelBuilder.Entity("StarboardNFT.Models.UserFollowing", b =>
                {
                    b.HasOne("StarboardNFT.Models.UserProfile", "FollowedUserProfile")
                        .WithMany()
                        .HasForeignKey("FollowedUserProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("FollowedUserProfile");
