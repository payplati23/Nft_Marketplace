...
namespace StarboardNFT.Data.Migrations
{
    ...
    [Migration("20210909094706_AddTotalNumberAndUniqueNumberOfMintedNFT")]
    partial class AddTotalNumberAndUniqueNumberOfMintedNFT
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StarboardNFT.Models.UserFollowing", b =>
                {
                    ...
                    b.Property<Guid>("FollowedUserProfileHeaderId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("MainUserProfileId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FollowedUserProfileHeaderId");

                    b.HasIndex("MainUserProfileId");
            ...
            modelBuilder.Entity("StarboardNFT.Models.UserFollowing", b =>
                {
                    b.HasOne("StarboardNFT.Models.UserProfileHeader", "FollowedUserProfileHeader")
                        .WithMany()
                        .HasForeignKey("FollowedUserProfileHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StarboardNFT.Models.UserProfile", "MainUserProfile")
                        .WithMany()
                        .HasForeignKey("MainUserProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FollowedUserProfileHeader");

                    b.Navigation("MainUserProfile");
                });
