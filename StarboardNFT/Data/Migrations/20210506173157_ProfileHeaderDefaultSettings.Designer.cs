...
namespace StarboardNFT.Data.Migrations
{
    ...
    [Migration("20210506173157_ProfileHeaderDefaultSettings")]
    partial class ProfileHeaderDefaultSettings
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StarboardNFT.Models.ProfileHeader", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("ProfileHeader");
                });

            modelBuilder.Entity("StarboardNFT.Models.ProfileSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StarboardNFT.Models.ProfileSettings", b =>
                {
                    b.HasOne("StarboardNFT.Models.ProfileHeader", "ProfileHeader")
                        .WithMany("ProfileSettings")
                        .HasForeignKey("ProfileHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProfileHeader");
                });
