...
namespace StarboardNFTLibrary.Contracts.StarboardCollection
{
    public partial class StarboardCollectionService
    {
        ...
        public static async Task<StarboardCollectionService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, StarboardNFTDeployment starboardNFTDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, starboardNFTDeployment, cancellationTokenSource);
            return new StarboardCollectionService(web3, receipt.ContractAddress);
        }
        ...
        public StarboardCollectionService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
